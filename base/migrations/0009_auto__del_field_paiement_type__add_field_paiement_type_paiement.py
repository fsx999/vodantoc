...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Paiement.type'
        db.delete_column(u'base_paiement', 'type_id')
    ...
    def backwards(self, orm):
        # Adding field 'Paiement.type'
        db.add_column(u'base_paiement', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='C', to=orm['base.TypePaiement'], blank=True),
                      keep_default=False)

        # Deleting field 'Paiement.type_paiement'
        db.delete_column(u'base_paiement', 'type_paiement_id')
    ...
    models = {
        ...
        u'base.paiement': {
            ...
            'type_paiement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.TypePaiement']"})
        },
        u'base.paysmodel': {
